...
class EventSequenceDurationGCNModel(nn.Module):
    def __init__(self, num_event_features, num_sequence_features, 
                 ...
                 gcn_dropout_flag_duration, gcn_dropout_rate_duration, gcn_activation_duration,
        ...
        super(EventSequenceDurationGCNModel, self).__init__()
        ...
        for j, hidden_dim in enumerate(gcn_hidden_dims_duration):
            self.gcn_layers_duration.append(GCNConv(in_duration, hidden_dim))
...
def objective(trial, model_save_folder, train_dataset, test_dataset, num_event_features, num_duration_features, num_sequence_features, output_dim, patience, epochs, device):
    ...
    model = EventSequenceDurationGCNModel(num_event_features=num_event_features, 
